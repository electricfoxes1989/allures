      ...
      <section className="bg-navy text-white py-28 md:py-40">
        <div className="max-w-7xl mx-auto px-6 md:px-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { href: "/shipyard", title: "The Shipyard", subtitle: yacht.builder, desc: "Advanced composite pioneers on the French Riviera." },
              { href: "/design", title: "Engineering", subtitle: yacht.navalArchitect, desc: "Carbon fibre innovation at the superyacht scale." },
